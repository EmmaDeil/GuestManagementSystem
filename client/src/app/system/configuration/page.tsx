    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
          <div className="mb-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">API Access</h2>
          ...
          <div>
            <div className="flex items-start sm:items-center gap-2 sm:gap-3 mb-3 bg-gray-50 p-3 rounded-lg border border-gray-200">
              <code className="flex-1 font-mono text-xs sm:text-sm md:text-base text-gray-900 tracking-tight break-all overflow-wrap-anywhere">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                disabled={isSaving}
                className="flex items-center justify-center gap-2 px-3 py-2 sm:py-1.5 border border-gray-300 rounded hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm w-full sm:w-auto"
              >
